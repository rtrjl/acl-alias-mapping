...
public class UpgradeNedSettings {
    public static final String NED = "cisco-ios";
    public static final String NED_ID = "ios-id:cisco-ios";
    ...
    private static void moveNedSettings(CdbSession oldcdb, Maapi newMaapi, int th, String root) {
        ...
        try {
            ...
            for (int i = 0; i < no; i++) {
                ...
                String frompath = String.format(root+"cisco-ios-replace-config[%d]", offset);
        ...
        try {
            ...
            for (int i = 0; i < no; i++) {
                ...
                String frompath = String.format(root+"cisco-ios-inject-config[%d]", offset);
        ...
        try {
            ...
            for (int i = 0; i < no; i++) {
                ...
                String frompath = String.format(root+"cisco-ios-inject-interface-config[%d]", offset);
        ...
        try {
            ...
            for (int i = 0; i < no; i++) {
                ...
                String frompath = String.format(root+"cisco-ios-inject-command[%d]", offset);
        ...
        try {
            ...
            for (int i = 0; i < no; i++) {
                ...
                String frompath = String.format(root+"cisco-ios-replace-commit[%d]", offset);
        ...
        try {
            ...
            for (int i = 0; i < no; i++) {
                ...
                String frompath = String.format(root+"cisco-ios-inject-answer[%d]", offset);
        ...
        try {
            ...
            for (int i = 0; i < no; i++) {
                ...
                String frompath = String.format(root+"cisco-ios-auto-prompts[%d]", offset);
